...
const BGRSlider = () => {
  ...
  return (
    <motion.div
      ...
      {/* Title */}
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold text-white bg-clip-text mb-12 sm:mb-20'>Remove Background with High <br /> Quality and Accuracy</h1>
